-- QiEOS Fixed Seed Data for Supabase
-- This version removes ON CONFLICT clauses that were causing errors
...
-- Now insert the seed data (without ON CONFLICT for now)
