    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Welcome back, {claims?.email}</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <span className="bg-gradient-to-r from-blue-600 to-indigo-400 font-bold text-3xl text-transparent bg-clip-text">
                12
              </span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <span className="bg-gradient-to-r from-green-600 to-emerald-400 font-bold text-3xl text-transparent bg-clip-text">
                3
              </span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <span className="bg-gradient-to-r from-yellow-600 to-orange-400 font-bold text-3xl text-transparent bg-clip-text">
                24
              </span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <span className="bg-gradient-to-r from-purple-600 to-pink-400 font-bold text-3xl text-transparent bg-clip-text">
                8
              </span>
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-gray-600">
                    Task "Review documents" completed
                  </span>
                </div>
                <div className="flex items-center space-x-3">
